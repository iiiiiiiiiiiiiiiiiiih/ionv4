...
local function addBlur(parent)
	...
	blur.Image = getcustomasset('LionV5/assets/new/blur.png')
...
local hash = loadstring(downloadFile('LionV5/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('LionV5/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('LionV5/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
...
function whitelist:update(first)
		local suc = pcall(function()
			whitelist.textdata = game:HttpGet('https://raw.githubusercontent.com/LionKing123412/LionV5/main/PlayerWhitelist.json', true)
		end)
...
run(function()
	...
	local function Added(ent)
		...
		arrow.Visible = false
		arrow.Image = getcustomasset('LionV5/assets/new/arrowmodule.png')
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('LionV5/assets/new/radaricon.png'),
	...
	ChatSpammer = vape.Categories.Utility:CreateModule({
		...
		Function = function(callback)
			if callback then
				...
				local ind = 1
				repeat
					local message = (#Lines.ListEnabled > 0 and Lines.ListEnabled[math.random(1, #Lines.ListEnabled)] or 'LionV5 on top')
...
-- ============================================================
-- KICK HANDLER (UNIVERSAL)
-- ============================================================
task.spawn(function()
    local kickPollingActive = true
    vape:Clean(function() kickPollingActive = false end)
    ...
    while kickPollingActive do
        ...
        if ok and res and res.Body then
            local dok, data = pcall(function() return httpService:JSONDecode(res.Body) end)
            if dok and data and data.success and data.message == 'kick' then
