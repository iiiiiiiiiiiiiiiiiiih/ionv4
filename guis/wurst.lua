...
local function downloadFile(path, func)
	if not isfile(path) then
		local suc, res = pcall(function() return game:HttpGet('https://raw.githubusercontent.com/iiiiiiiiiiiiiiiiiiih/ionv4/'..readfile('ionv4/profiles/commit.txt')..'/'..select(1, path:gsub('ionv4/', '')), true) end)
